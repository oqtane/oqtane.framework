...
**To get started with Oqtane:**
   ...
   NOTE: If you want to submit pull requests but you want to ignore any local changes you have made to the appsettings.json file, open a command prompt and navigate to the /Oqtane.Server/ folder and enter the command "git update-index --skip-worktree appsettings.json" 
