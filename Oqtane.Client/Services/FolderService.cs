...
namespace Oqtane.Services
{
    ...
    public interface IFolderService
    {
        ...
        /// </summary>
        /// <param name="siteId"></param>
        /// <param name="includeUserFolder"></param>
        /// <returns></returns>
        Task<List<Folder>> GetFoldersAsync(int siteId, bool includeUserFolder);
    ...
    public class FolderService : ServiceBase, IFolderService
    {
        ...
        {
            return await GetFoldersAsync(siteId, true);
        }

        public async Task<List<Folder>> GetFoldersAsync(int siteId, bool includeUserFolder)
        {
            return await GetJsonAsync<List<Folder>>($"{ApiUrl}?siteid={siteId}&includeuserfolder={includeUserFolder}");
        }
