...
namespace Oqtane.Shared
{
    ...
    {
        public static readonly string Version = "10.3.0";
        public const string ReleaseVersions = "1.0.0,1.0.1,1.0.2,1.0.3,1.0.4,2.0.0,2.0.1,2.0.2,2.1.0,2.2.0,2.3.0,2.3.1,3.0.0,3.0.1,3.0.2,3.0.3,3.1.0,3.1.1,3.1.2,3.1.3,3.1.4,3.2.0,3.2.1,3.3.0,3.3.1,3.4.0,3.4.1,3.4.2,3.4.3,4.0.0,4.0.1,4.0.2,4.0.3,4.0.4,4.0.5,4.0.6,5.0.0,5.0.1,5.0.2,5.0.3,5.1.0,5.1.1,5.1.2,5.2.0,5.2.1,5.2.2,5.2.3,5.2.4,6.0.0,6.0.1,6.1.0,6.1.1,6.1.2,6.1.3,6.1.4,6.1.5,6.2.0,6.2.1,10.0.0,10.0.1,10.0.2,10.0.3,10.0.4,10.1.0,10.1.1,10.1.2,10.2.0,10.2.1,10.2.2,10.2.3,10.2.4,10.2.5,10.2.6,10.3.0";
        ...
        public const string PublicFolderProvider = "DefaultPublic";
        public const string PrivateFolderProvider = "DefaultPrivate";

        public static readonly string[] DefaultFolderProviders = { PublicFolderProvider, PrivateFolderProvider };
